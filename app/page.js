...
export default function Home() {
  ...
  return (
    <main className="flex min-h-screen flex-col items-center overflow-hidden relative top-0 left-0 w-full">
      {/* banner section */}
      <section className="hidden xl:flex main-banner w-full min-h-[680px] overflow-hidden flex-col justify-end  ">
          ...
          <div className="flex flex-col mx-auto w-1/2 xl:w-1/2 justify-start gap-6 p-4">
            ...
            <div>
              <Linky to="sectionscroll" smooth={true} duration={600}
                className="relative overflow-hidden  py-3 pl-10 pr-14 bg-[#FFB800] rounded-3xl mx-auto text-black group priority-btn text-center font-bold my-5 m-[0 auto]">
                <span className="text-xl relative z-50 bg-[#FFB800] px-2">Sign Up</span>
                <span
      ...
      {/* tab-banner */}
      <section
        className="hidden sm:flex xl:hidden tab-banner w-full min-h-[680px] overflow-hidden flex-col justify-end  ">
      ...
      <section className="w-full bg-white hidden sm:flex lg:hidden">
